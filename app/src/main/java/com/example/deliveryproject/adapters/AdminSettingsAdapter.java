...
public class AdminSettingsAdapter extends ArrayAdapter<Items.Setting> {
    Items.Setting[] settings;
    Context context;
    FragmentManager fragmentManager;

    public AdminSettingsAdapter(@NonNull Context context,
                               int resource,
    ...
    // Метод для получения и показа истории покупок
